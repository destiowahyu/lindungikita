...
import logo from '../assets/logo.png'; // Sesuaikan dengan path dan nama file logo
    ...
    <header className="bg-white shadow-md fixed top-0 left-0 w-full z-10">
      <div className="container mx-auto px-4 py-2 md:py-4 flex justify-between items-center">
        <div className="flex items-center">
          <img src={logo} alt="Logo LindungiKita" className="h-8 md:h-10 mr-2" /> {/* Sesuaikan tinggi logo di sini */}
